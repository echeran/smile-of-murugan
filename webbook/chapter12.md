...
as found in the twelve books of the Śaivite canon called *Tirumuṟai*.
...
probably the earliest of Tamil Śaiva saints and by Cēramāṉ Perumāḷ
a contemporary of Cuntarar, the *Tirumurukāṟṟuppaṭai* (from
*Pattuppāṭṭu*) by Nakkīratēvar, Paṭṭiṉattār's stanzas, and the two
...
hand (e.g. by Cāmi Citamparaṉār, C. Rakunātaṉ and others). In
...
Periyāḻvār);
* about 35% of Kṣatriya origin (e.g. Cēramāṉ Perumāḷ, Kulacēkara
...
eyes of the Lord is precisely one part of the message of the Nāyaṉmārs
...
[^bhakta]: The equivalent Tamil term is *toṇṭaṉ*, pl. *toṇṭar*, “servant” or *aṭiyāṉ*
"slave". There are two kinds of saints: the "hard" servants (*vaṉtoṇṭar*), the
ones whom ordinary men cannot follow (they are the truly a-social or
probably even anti-social ones), and the "soft" servants (*meṉtoṇṭar)* who
became a model for all to follow. A typical *vaṉtoṇṭar* is, e.g., the hunter
Kaṇṇappaṉ.
...
asceticism and renunciation; there are, of course, *vaṉ toṇṭar* who
...
to the highest caste, he becomes the Lord's comrade (*tōlaṉ*). However,
...
Kūṭal and Kōḻi; or Cēramāṉ Perumāḷ; or Tirumaṅkai Āḻvār, the
...
* S<sub>1</sub> - the interior state of the subject of the cult;
* S<sub>2</sub> - the external actions of the subject of the cult;
* O<sub>1</sub> - the respective reaction of the object of the cult in relation to
the subject;
* O<sub>2</sub> - the state, qualities or actions of the object of the cult irrespective
of the given relation to the subject; O<sub>2</sub> has usually the
form of a synchronic projection of an event in diachrony.

As an example of a stanza which illustrates the complete pattern
S<sub>1</sub> S<sub>2</sub> O<sub>1</sub> O<sub>2</sub> we may quote one of the earliest Śaiva *bhakti* poems,
...
* S<sub>1</sub> = "O heart .... in the fullness of love";
* S<sub>2</sub> = "praise always";
* O<sub>1</sub> = "who will redeem us when the day comes";
* O<sub>2</sub> = the rest.
...
literature is that kind of literature in which O<sub>2</sub> plays
...
The segmentation of the information into S<sub>1</sub>, S<sub>2</sub>, O<sub>1</sub> and O<sub>2</sub> enables
...
the hypertrophy of S<sub>1</sub> in many Tamil hymns, and its almost complete
...
the Tamil hymns is the relation S<sub>2</sub> O<sub>1</sub>: what does the devotee ask for
when addressing God, and what does God grant him.

The analysis of S<sub>2</sub> O<sub>1</sub> shows that in the Vedic hymns man demands
...
cult, which has some unique, specific relation to the sphere of S<sub>2</sub> O<sub>1</sub>
...
material ritual is only a facultative component of S<sub>2</sub>.
...
The segment O<sub>2</sub> fills the greater part of Sanskrit *purāṇas*: the
...
In the Tamil hymns, the material of O<sub>2</sub> is usually telescoped into
...
The fact that S<sub>1</sub>, S<sub>2</sub>, O<sub>1</sub>, O<sub>2</sub> were posited as segments of the
...
O<sub>2</sub>. The content of S<sub>2</sub> is mostly Campantar's struggle with the
...
filled with material related to O<sub>2</sub>, mostly in epithetic form. A favourite
...
Therefore, apart from O<sub>2</sub> which is also strongly developed in Appar's
poetry, there is a strong element of S<sub>1</sub> and S<sub>2</sub>. One of the important
...
is a clear hypertrophy of the segment S<sub>1</sub>. Religious emotion achieves,
...
divine grace. The segment S<sub>2</sub> is almost entirely suppressed, since
...
Observe the fact that, in both poems, the segment S<sub>2</sub>—in contrast
to Campantar's and Cuntarar's hymns—equals zero; the segment
O<sub>2</sub> is developed, but not too strongly (in contrast, e.g., to Appar's
or Campantar's poems). It is the segments S<sub>1</sub> and O<sub>1</sub> which are
filled with material. The second hymn in particular has a neat
pattern of S<sub>1</sub> O<sub>1</sub> (O<sub>2</sub>).
